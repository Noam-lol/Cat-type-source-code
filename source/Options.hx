...
class CpuStrums extends Option
{
	...
	private override function updateDisplay():String
	{
		return  FlxG.save.data.cpuStrums ? "daddy hits notes" : "weird cpu thang";
	}
...
class DownscrollOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.downscroll ? "shit poop scroll" : "ChadScroll Up";
	}
}
...
class GhostTapOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.ghost ? "ZERO IQ INPUT" : "COOL KID INPUT";
	}
}
...
class ScoreScreen extends Option
{
	...
	private override function updateDisplay():String
	{
		return (FlxG.save.data.scoreScreen ? "Score Screen on" : "No Score Screen");
	}
}
...
class Optimization extends Option
{
	public function new(desc:String)
		...
		private override function updateDisplay():String
		{
			return "" + (FlxG.save.data.optimize ? "DOODOO FART PC" : "COOL KID SEE VISUALS");
		}
}
...
class AccuracyDOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "accuracy: " + (FlxG.save.data.accuracyMod == 0 ? "fake" : "da tru tru");
	}
}
...
class WatermarkOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "" + (Main.watermarks ? "TURN IT OFF" : "OFF");
	}
}
